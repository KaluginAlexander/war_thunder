...
class Protect:
    ...
    def __load_icon(self):
        ...
        self._sprite = load('files/textures/icons/protect.png').convert_alpha() 
    ...
    def __get_start_config(self):
        ...
        self._icon_y = self._surface_height - self.margin - self.icon_height
    ...
    def __print_text(self, player):
        ...
        points_for_interface = self.font.render(f"{protect}", 1, (255, 255, 255))
